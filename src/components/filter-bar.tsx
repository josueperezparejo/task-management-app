...
export function FilterBar() {
  ...
  return (
    <div className="mb-6 flex flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-green-900/40 sm:flex-row sm:items-center sm:justify-between">
